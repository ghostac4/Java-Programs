...
public class SearchingTimeComparision
{
   ...
   public static void main(String[] args)
   {
      ...
      String path = "dummyText.txt";
      String separator = " ";
      long[] elapsedTime = new long[6];
      String[] sortingTitles = { "Binary Search for integer", "Binary Search of String", "Insertion Sorting of Integer",
            "Insertion Sorting of String", "Bubble Sorting of Integer", "Bubble Sorting for String" };
