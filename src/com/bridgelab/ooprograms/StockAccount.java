...
public class StockAccount {
	...
	private String path = "/home/bridgeit/Desktop/List/";
	 ...
	 * @param symbol
	 *            is string representing company
	 */
	...
	public void getCompanyShares() {
		String jsonStringInput = Utility.readFromFile("/home/bridgeit/Desktop/List/" + "companyShares.json");
	...
	public void saveCompanyShares() {
		...
		if (companySharesList != null) {
			...
			Utility.writeToFile(JSONValue.toJSONString(jsonArray),
					"/home/bridgeit/Desktop/List/" + "companyShares.json");
		}
	}
}
